...
<div id="wrapper">
    ...
    <%@include file="../dynamic/nagivationMenu.jspf"%>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <form name="sendEditPerson" method="post" action='<c:url value="/personList/${person.id}/"/>'>
                    <!-- Content Row -->
                    <div class="row">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    ...
                                    <c:if test="${person.checkbox eq '0'}">
                                        <input type="hidden" value="${person.java}" name="java"> <input type="hidden" value="${person.bestPractice}" name="bestPractice"><input type="hidden" value="${person.tdd}" name="tdd"> <input type="hidden" value="${person.question}" name="question"> <input type="hidden" value="${person.hibernate}" name="hibernate"> <input type="hidden" value="${person.html}" name="html"> <input type="hidden" value="${person.jsp}" name="jsp"> <input type="hidden" value="${person.thymeleaf}" name="thymeleaf"> <input type="hidden" value="${person.git}" name="git">
                                    </c:if>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-1">
                                            <label class="radio-inline"><input type="radio" id="question"
                                                    ...
                                                    test="${person.checkbox eq '1'}"> checked</c:if>>TAK
                                            </label>
                                        </div>
                                        <div class="col-1">
                                            <label class="radio-inline"><input type="radio" id="question"
                                                                               name="checkbox" value="0"
                                            <c:if test="${person.checkbox eq '0'}"> checked</c:if>>NIE
                                            </label>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <form name="deletePerson" method="post" action='<c:url
        ...
        <%@include file="../dynamic/bizard.jspf"%>
